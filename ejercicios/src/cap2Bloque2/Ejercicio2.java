...
public class Ejercicio2 {
	...
	public static void calculo() {
		System.out.println("Vamos a introducir unos numeros y vamos a sumarlos en unos grupos"); // Explicamos que
																									// realiza el
																									// programa
		String var = JOptionPane.showInputDialog("Introduzca un numero: "); // Obtenemos valor para los calculos
																			// necesarios
		int num = Integer.parseInt(var); // Convertimos en entero
		String var2 = JOptionPane.showInputDialog("Introduzca un numero: "); // Obtenemos valor para los calculos
																				// necesarios
		int num2 = Integer.parseInt(var2); // Convertimos en entero
		String var3 = JOptionPane.showInputDialog("Introduzca un numero: "); // Obtenemos valor para los calculos
																				// necesarios
		int num3 = Integer.parseInt(var3); // Convertimos en entero
		String var4 = JOptionPane.showInputDialog("Introduzca un numero: "); // Obtenemos valor para los calculos
																				// necesarios
		int num4 = Integer.parseInt(var4); // Convertimos en entero
		String var5 = JOptionPane.showInputDialog("Introduzca un numero: "); // Obtenemos valor para los calculos
																				// necesarios
